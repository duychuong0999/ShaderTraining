...
public class Triangle
{
    ...
    public Triangle(Vector3 v1, Vector3 v2, Vector3 v3,int id1,int id2, int  id3)
    {
        this.v1 = new Vertex(v1, id1);
        this.v2 = new Vertex(v2, id2);
        this.v3 = new Vertex(v3, id3);
    }
...
public class Edge
{
    ...
    public Edge(Vector3 v1, Vector3 v2, int id1, int id2)
    {
        this.v1 = new Vertex(v1, id1);
        this.v2 = new Vertex(v2, id2);
    }
